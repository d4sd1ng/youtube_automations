...
const AvatarGenerationAgent = require('../../agents-orchestrator/modules/avatar-generation/avatarGenerationAgent');
const VideoProcessingAgent = require('../../agents-orchestrator/modules/video-processing/videoProcessingAgent');
const ScriptGenerationAgent = require('../../agents-orchestrator/modules/script-generation/scriptGenerationAgent');
const SEOOptimizationAgent = require('../../agents-orchestrator/modules/seo-optimization/seoOptimizationAgent');
const WebScrapingAgent = require('../../agents-orchestrator/modules/web-scraping/webScrapingAgent');
const ContentApprovalAgent = require('../../agents-orchestrator/modules/content-approval/contentApprovalAgent');
