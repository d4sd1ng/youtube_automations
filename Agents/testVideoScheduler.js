const VideoSchedulerAgentAgent = require('./VideoSchedulerAgentAgent');

async function testVideoSchedulerAgentAgent() {
  console.log('🚀 Testing VideoSchedulerAgentAgent...');
  
  try {
    // Create scheduler instance
    const scheduler = new VideoSchedulerAgentAgent();
